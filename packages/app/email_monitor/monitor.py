...
from exceptions import EmailTriggerError
from services import WindmillClient
...
class EmailMonitor:
    ...
    def __init__(self, credentials: MSGraphCredentials, wmill_client: WindmillClient):
    ...
    def process_message(self, msg: Message) -> EmailProcessingResult:
        ...
        if require_attachments:
            ...
            # Check if the flow requires a single base64 attachment or list of file paths
            input_files_schema = (
